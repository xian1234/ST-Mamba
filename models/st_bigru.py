...
class TemporalFusionModule(nn.Module):
    """
    Temporal fusion module using bidirectional GRU for sequence modeling.
    """
    def __init__(self, in_features=512, feature_dim=512):
        super().__init__()
...
class STBiGRU(nn.Module):
    """
    Spatio-Temporal BiGRU model for multi-decadal heritage monitoring.
    Decouples static context (spatial features from last timestep) and dynamic changes (temporal fusion via BiGRU).
